...
(function barcodeScannerAddon(){
  ...
  const dlg = document.getElementById('scannerModal');
  const viewport = document.getElementById('scannerViewport');
  const btnCancel = document.getElementById('scannerCancel');
  ...
  const BTN_SCAN_POS = document.getElementById('btnScanPos');
  const BTN_SCAN_RK  = document.getElementById('btnScanRack');
  const BTN_SCAN_VAL = document.getElementById('btnScanVal');

  const IN_POS = document.getElementById('valPosicion');
  const IN_RK  = document.getElementById('valRack');
  const IN_COD = document.getElementById('valCodigo');

  bindScan(BTN_SCAN_POS, IN_POS);
